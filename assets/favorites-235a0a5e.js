import{s as g,a as p,o as S}from"./modal-exercise-45d228d6.js";function h(t){return t.map(({_id:o,bodyPart:s,name:a,target:n,burnedCalories:d})=>`<li class="favorites-rating_item js-workout-card" data-id="${o}">
